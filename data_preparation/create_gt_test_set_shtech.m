...
path = ['E:\Su\UAV_project\dataset\ShanghaiTech\part_' dataset '_final\test_data\images\'];
gt_path = ['E:\Su\UAV_project\dataset\ShanghaiTech\part_' dataset '_final\test_data\ground_truth\'];
